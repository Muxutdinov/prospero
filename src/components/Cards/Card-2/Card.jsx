  ...
  return <div className='cardikki'>
    ...
    <div className="right">
      <div className="cardtop">
        ...
        <img className='bookmarkikki' src={bookmark} ></img>
      </div>
      ...
      <div className="comments">
          ...
          <div className="commentItem"><img src={Comment}/>  <div className='cardnumber'>27</div></div>
          <div className="commentItem"><img src={Heart} />  <div className='cardnumber'>129</div></div>
      </div>
    </div>
  </div>;
};
