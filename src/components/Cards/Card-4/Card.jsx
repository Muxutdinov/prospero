  ...
  return <div className='cardtort'>
    ...
    <div className="right">
      ...
      <div className="comments">
          ...
          <div className="commentItem"><img src={Comment}/>  <div className='cardnumber'>5</div></div>
          <div className="commentItem"><img src={Heart} />  <div className='cardnumber'>82</div></div>
      </div>
    </div>
  </div>;
};
